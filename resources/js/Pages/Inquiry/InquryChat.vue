                            ...
                            <ul class="space-y-2 h-full">
                                ...
                                <li class="text-gray-600 border-b border-gray-100 sm:px-4 px-2 py-1 space-y-1">
                                    <p class="flex items-center gap-2">
                                        Status<span v-if="inquiry.status === 'open'"
                                            class="bg-blue-600 text-white px-4 py-1 rounded-lg text-sm">Open</span>
                                        <span v-else
                                            class="bg-red-400 text-white px-4 py-1 rounded-lg text-sm">Close</span>
                                    </p>
                                </li>
                                ...
                                <div class="chat-message">
                                    <div class="flex items-end"
                                        ...
                                        <div class="flex flex-col space-y-2 text-sm sm:text-base max-w-sm mx-2 order-1"
                                            ...
                                            <div>
                                                <span
                                                    class="px-4 py-2 rounded-lg inline-block rounded-br-none  text-black"
                                                    :class="{
                        ...
                        <div class="border-t-2 border-gray-200 pt-4 mb-2 sm:mb-0 px-2 sm:px-4">
                            <div class="relative flex">
                                <input type="text" placeholder="Write your message!" v-model="form.message"
                                    ...
                                    class="focus:ring-[#ffb61a] focus:shadow-[#ffb61a] focus:border-[#ffb61a] border-[#ffb61a] w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-2 bg-gray-100 rounded-md py-3"
