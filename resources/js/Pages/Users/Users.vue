    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="float-right">
          <inertia-link :href="route('create-users')" v-if="$page.props.auth.user.type == 'admin'"
            class="btn btn-success btn-sm"><i class="fas fa-plus"></i> ADD NEW</inertia-link>
        </div>
      </div>
      <div class="card-body">
        <div class="row">
          ...
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <tr v-for="user in users.data" :key="user.id">
                ...
                <td>{{ user.type }}</td>
                <td>
                  <inertia-link :href="route('edit-users', { id: user.id })" class="btn btn-info btn-sm"><i class="fas fa-edit"></i> Edit</inertia-link>
